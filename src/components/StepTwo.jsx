    ...
    >
      ...
      <div className="flex justify-between mt-6">
        <button
          type="button"
          onClick={prevStep}
          className="bg-gray-200 text-black py-2 px-6 rounded-lg font-semibold hover:bg-gray-300"
        >
          Back
        </button>
        <button
          type="submit"
          className="bg-cyan-400 text-black py-2 px-6 rounded-lg font-semibold hover:bg-cyan-500"
        >
          Submit
        </button>
      </div>
